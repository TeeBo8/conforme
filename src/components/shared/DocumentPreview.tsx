    ...
    <div className="relative rounded-xl border border-border overflow-hidden">
      ...
      <div
        className="
          ...
          [&_ul]:text-sm [&_ul]:text-foreground/80 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-1 [&_ul]:mb-3
          [&_li]:leading-relaxed
          ...
          [&_td]:p-2.5 [&_td]:border [&_td]:border-foreground/10 [&_td]:text-foreground/75 [&_td]:align-top [&_td]:leading-relaxed
          [&_section]:mb-1
          [&_header]:mb-8 [&_header]:pb-6 [&_header]:border-b [&_header]:border-foreground/10
          [&_.document-date]:block [&_.document-date]:text-xs [&_.document-date]:text-muted-foreground [&_.document-date]:mt-1
          [&_.document-intro]:text-sm [&_.document-intro]:text-foreground/75 [&_.document-intro]:leading-relaxed [&_.document-intro]:mt-3 [&_.document-intro]:pl-3 [&_.document-intro]:border-l-2 [&_.document-intro]:border-foreground/15
          [&_.document-disclaimer]:mt-10 [&_.document-disclaimer]:pt-4 [&_.document-disclaimer]:border-t [&_.document-disclaimer]:border-foreground/10 [&_.document-disclaimer]:text-xs [&_.document-disclaimer]:text-muted-foreground
